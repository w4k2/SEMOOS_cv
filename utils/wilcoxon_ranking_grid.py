...
def pairs_metrics_multi_grid(method_names, data_np, experiment_name, dataset_names, metrics, filename, ref_methods, offset, treshold=0.5, set_metric_name=False):
    # Load data
    data = {}
