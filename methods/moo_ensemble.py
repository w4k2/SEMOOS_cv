...
from methods.optimization_param_with_cross_val import OptimizationParamCrossVal
...
class MooEnsembleSVC(BaseEstimator):
    ...
    def partial_fit(self, X, y, classes=None):
        ...
        if self.cross_val is True:
            problem = OptimizationParamCrossVal(X, y, test_size=self.test_size, estimator=self.base_classifier, scale_features=self.scale_features, n_features=n_features, objectives=self.objectives)
        else:
